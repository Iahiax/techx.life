...
<div class="container-fluid">
        ...
        <div class="col-md-3">
            <div class="card bg-info text-white h-100">
                <div class="card-body">
                    <div class="d-flex justify-content-between align-items-center">
                        <div>
                            <h6 class="card-title">الحسابات المرتبطة</h6>
                            <h2 class="mb-0">{{ number_format($accounts_count) }}</h2>
                        </div>
    ...
    <div class="row g-3 mb-4">
        <div class="col-md-4">
            <div class="card border-success">
                <div class="card-body">
                    <h6 class="card-title text-success">إجمالي المبالغ المدفوعة</h6>
                    <h3>{{ number_format($stats['total_paid'], 2) }} ريال</h3>
                </div>
            </div>
        </div>
        <div class="col-md-4">
            <div class="card border-danger">
                <div class="card-body">
                    <h6 class="card-title text-danger">إجمالي المبالغ المتبقية</h6>
                    <h3>{{ number_format($stats['remaining_amount'], 2) }} ريال</h3>
                </div>
            </div>
        </div>
        <div class="col-md-4">
    ...
    <div class="row">
        ...
        <div class="col-lg-6 mb-4">
            <div class="card shadow-sm">
                <div class="card-header bg-white d-flex justify-content-between align-items-center">
                    <h5 class="mb-0">آخر 5 استقطاعات</h5>
                    <a href="{{ route('customer.deductions.index') }}" class="btn btn-sm btn-outline-primary">عرض الكل</a>
                </div>
                    ...
                    <div class="table-responsive">
                        <table class="table table-hover mb-0">
                            ...
                            <tbody>
                                ...
                                @empty
                                <tr>
                                    <td colspan="4" class="text-center text-muted py-3">لا توجد استقطاعات حديثة</td>
                                </tr>
                                @endforelse
                            </tbody>
                        </table>
        ...
        <div class="col-lg-6 mb-4">
            <div class="card shadow-sm">
                <div class="card-header bg-white d-flex justify-content-between align-items-center">
                    <h5 class="mb-0">آخر 5 عقود</h5>
                    <a href="{{ route('customer.contracts.index') }}" class="btn btn-sm btn-outline-primary">عرض الكل</a>
                </div>
                <div class="card-body p-0">
                    <div class="table-responsive">
                        <table class="table table-hover mb-0">
                            ...
                            <tbody>
                                ...
                                @empty
                                <tr>
                                    <td colspan="4" class="text-center text-muted py-3">لا توجد عقود حديثة</td>
                                </tr>
                                @endforelse
                            </tbody>
                        </table>
        ...
        <div class="col-12">
            <div class="card shadow-sm">
                <div class="card-header bg-white d-flex justify-content-between align-items-center">
                    ...
                    <a href="{{ route('customer.notifications.index') }}" class="btn btn-sm btn-outline-primary">عرض الكل</a>
                </div>
                <div class="card-body p-0">
